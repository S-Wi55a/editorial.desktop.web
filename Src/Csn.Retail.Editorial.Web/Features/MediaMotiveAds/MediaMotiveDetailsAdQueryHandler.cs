...
{
    [AutoBind]
    public class MediaMotiveDetailsAdQueryHandler : IQueryHandler<MediaMotiveDetailsAdQuery, MediaMotiveAdViewModel>
    {
        public MediaMotiveAdViewModel Handle(MediaMotiveDetailsAdQuery query)
        {
