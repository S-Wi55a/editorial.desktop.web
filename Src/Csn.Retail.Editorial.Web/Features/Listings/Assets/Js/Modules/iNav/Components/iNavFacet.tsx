...
const mapStateToProps = (state: any) => {
  return {
      pendingAction: typeof state.store.listings.navResults.iNav.pending !== 'undefined' ? state.store.listings.navResults.iNav.pending.action : state.store.listings.navResults.iNav.currentAction,
  }
}
