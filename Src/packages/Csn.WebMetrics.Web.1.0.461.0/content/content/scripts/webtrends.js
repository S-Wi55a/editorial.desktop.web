...
// Added dcsAll and updated dcsNavigation to check for data-wt.nv attribute. Nick M. 8/8/2011
// Enabled dcsCleanup to remove inherited parameters from click events. Nick M. 8/24/2011

if (collectedOnce === undefined)
    var collectedOnce = false;

function WebTrends(fpcdom,dcsid){
	var that=this;
	...
	this.navigationtag="a,div,table";
...
WebTrends.prototype.dcsNavigation=function(evt){
	...
	for (i=0;i<elen;i++){
		...
		if (elem.length){
			...
			//Code section to check for data-wt.nv attribute
			if (e.getAttribute&&e.getAttribute("data-wt.nv")){
				id=e.getAttribute("data-wt.nv");
			}
			else if (e.getAttribute&&e.getAttribute("id")){
...
WebTrends.prototype.dcsET=function(){
	...
	if (this.WT.trackAllEvents){this.dcsBind(e,this.dcsAll);}
	this.dcsBind(e,this.dcsOffsite);
	this.dcsBind("contextmenu",this.dcsRightClick);
}
WebTrends.prototype.dcsMultiTrack=function(){
	//Clear inherited parameters
	if (this.ParameterCleanup)	{
		this.dcsCleanUp();
		this.dcsVar();
	}
...
WebTrends.prototype.dcsAll=function(evt){
...
WebTrends.prototype.dcsCollectNoSend = function () {
    if (this.enabled) {
        this.dcsVar();
        this.dcsAdv();
        if (typeof (this.dcsCustom) == "function") {
